...
<%
	...
	// Giornata di cui inserire il pronostico
	Schedina toInsertEsito = utente.getToPlayBet();
	if (toInsertEsito == null) {
		ArrayList<String> gameList = new ArrayList<String>();
		for(int i=1; i<11; i++) gameList.add(new String(""));
		toInsertEsito = new Schedina(0,null,gameList,null);
		
		session.setAttribute("info", "Non è stata trovata alcuna schedina per cui inserire il pronostico!");
...
<body>
	...
	<article class="panel">
		<div class="panel__copy">
			...
			<p>Ritorna alla tua <a href="<%=request.getContextPath()%>/user.jsp">Area Personale</a> senza inviare la schedina.</p>
		</div>
